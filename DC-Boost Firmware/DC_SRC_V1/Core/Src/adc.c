...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, INPUT_CURR_Pin|OUTPUT_CURR_Pin|ISO_VOLT_INPUT_TERMINAL_Pin|ISO_VOLT_OUTPUT_TERMINAL_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(GPIOA, ADC_12V_ILM_Pin|ADC_7V_ILM_Pin);
